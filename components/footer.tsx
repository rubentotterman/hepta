        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link href="/tjenester" className="hover:text-orange-500">
                  Alle tjenester
                </Link>
              </li>
              <li>
                <Link href="/tjenester/teknologi" className="hover:text-orange-500">
                  Teknologi
                </Link>
              </li>
              <li>
                <Link href="/tjenester/app-utvikling" className="hover:text-orange-500">
                  App-utvikling
                </Link>
              </li>
              <li>
                <Link href="/tjenester/ai" className="hover:text-orange-500">
                  AI
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>
                <Link href="/om-oss" className="hover:text-orange-500">
                  Om Hepta
                </Link>
              </li>
              <li>
                <Link href="/kontakt" className="hover:text-orange-500">
                  Kontakt oss
                </Link>
              </li>
            </ul>
