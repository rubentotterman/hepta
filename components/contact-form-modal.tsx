    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>Fortell oss litt om ditt prosjekt, så tar vi kontakt innen 24 timer.</DialogDescription>
        </DialogHeader>
        ...
        {isSubmitted ? (
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <p className="text-gray-400">Vi har mottatt din melding og vil kontakte deg innen kort tid.</p>
          </div>
        ) : (
