...
export default function Home() {
  ...
  const section1Data = {
    ...
    paragraphs: [
      "Vi går dypere enn bare utførelse...",
      "Vår prosess er transparent og fokusert på suksess.",
    ],
  ...
  const section2Data = {
    ...
    paragraphs: [
      "Vi kombinerer nyskapende design med teknologi...",
      "Kvalitet og innovasjon i alt vi gjør.",
    ],
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="mx-auto max-w-[800px] text-center">
              <h1 className="animate-fade-in bg-gradient-to-br from-white to-gray-400 bg-clip-text text-5xl font-extrabold leading-tight tracking-tight text-transparent sm:text-6xl md:text-7xl">
                Vi forvandler digitale rom til vekstreiser gjennom sømløs
                sammenfletting av visjon og presisjon.
              </h1>
